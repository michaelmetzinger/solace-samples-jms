...
public class HowToEnablePayloadCompression {
    ...
    /**
     * Sample of how to create an {@code InitialContext} with payload compression enabled. Note: if the connection
     * factory sets the compressed payload level it will override the value set via initial context.
     *
